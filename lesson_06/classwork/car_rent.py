...
class CarRent:
    ...
    def book(self):
        print(f"Booking {self.car} for {self.duration} hours")
        print(f"by {self.user.name}")
...
class Discount:
    ...
    def apply(self) -> None:
        """Reduce total price if today is BTHD"""
...
@handle_base_errors
def main():
    john = User(name="John", birthday=date(year=1990, month=11, day=3))
